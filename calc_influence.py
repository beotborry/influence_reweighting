...
if args.calc_option == "grad_V":
    get_grad_V(args.constraint, valid_loader, model, dataset, seed, sen_attr, main_option, save=True, split=split)
elif args.calc_option == "s_test":
    get_avg_s_test(model, valid_loader, train_sampler, args.constraint, weights, r, dataset, seed, sen_attr, t, option, main_option, save=True, split=split)
elif args.calc_option == "influence":
    get_influence_score(model, train_loader, valid_loader, train_sampler, args.constraint, weights, dataset, seed, sen_attr, t, r, option, main_option, load_s_test=True, split=split)
