...
do 
	#python3 main_final.py --dataset adult --method naive --seed $seed --constraint eo --epoch 50 --iteration 1 --gpu 0 --sen_attr sex --fine_tuning 0 --main_option fair_only
	...
	do
		python3 main_final.py --dataset adult --method naive_leave_k_out --seed $seed --constraint eo --epoch 50 --iteration 1 --gpu 3 --k $k --sen_attr sex --fine_tuning 0 --main_option fair_only
		python3 main_final.py --dataset adult --method naive_leave_bottom_k_out --seed $seed --constraint eo --epoch 50 --iteration 1 --gpu 3 --k $k --sen_attr sex --fine_tuning 0 --main_option fair_only
	done
done
