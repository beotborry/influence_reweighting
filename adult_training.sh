...
do 
	python3 main_final.py --dataset adult --method naive --seed $seed --constraint eopp --epoch 50 --iteration 1 --gpu 3
	...
	do
		python3 main_final.py --dataset adult --method naive_leave_k_out --seed $seed --constraint eopp --epoch 50 --iteration 1 --gpu 3 --k $k
		python3 main_final.py --dataset adult --method naive_leave_bottom_k_out --seed $seed --constraint eopp --epoch 50 --iteration 1 --gpu 3 --k $k
	done
done
