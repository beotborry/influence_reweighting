...
for seed in 888
do 
	# python3 main_final.py --dataset adult --method naive --seed $seed --constraint eopp --epoch 30 --iteration 1 --gpu 0 --sen_attr sex --fine_tuning 0 --main_option fair_only --log_option all
	# python3 calc_influence.py --option fair --dataset adult --seed $seed --constraint eopp --r 30 --t 1000 --gpu 0 --calc_option grad_V --target None --sen_attr sex --main_option fair_only
	# python3 calc_influence.py --option fair --dataset adult --seed $seed --constraint eopp --r 30 --t 1000 --gpu 0 --calc_option grad_V --target None --sen_attr sex --main_option fair_only
	# python3 calc_influence.py --option fair --dataset adult --seed $seed --constraint eopp --r 30 --t 1000 --gpu 0 --calc_option s_test --target None --sen_attr sex --main_option fair_only
	python3 calc_influence.py --option fair --dataset adult --seed $seed --constraint eopp --r 30 --t 1000 --gpu 0 --calc_option influence --target None --sen_attr sex --main_option fair_only	
	...
	# python3 main_final.py --dataset adult --method naive_leave_k_out --seed $seed --constraint eopp --epoch 30 --iteration 1 --gpu 0 --k 0.1 --sen_attr sex --fine_tuning 0 --main_option fair_only --log_option last
	# python3 main_final.py --dataset adult --method naive_leave_k_out --seed $seed --constraint eopp --epoch 30 --iteration 1 --gpu 0 --k 1 --sen_attr sex --fine_tuning 0 --main_option fair_only --log_option last
