...
do
	...
	python3 influence_function_test.py --sen_attr sex --dataset compas --seed $seed --constraint eopp --r 5 --t 1000 --gpu 2 --calc_option grad_V --target None
	python3 influence_function_test.py --sen_attr sex --dataset compas --seed $seed --constraint eopp --r 5 --t 1000 --gpu 2 --calc_option s_test --target None
	python3 influence_function_test.py --sen_attr sex --dataset compas --seed $seed --constraint eopp --r 5 --t 1000 --gpu 2 --calc_option influence --target None
...
do
	...
	python3 influence_function_test.py --sen_attr race --dataset compas --seed $seed --constraint eopp --r 5 --t 1000 --gpu 2 --calc_option grad_V --target None
	python3 influence_function_test.py --sen_attr race --dataset compas --seed $seed --constraint eopp --r 5 --t 1000 --gpu 2 --calc_option s_test --target None
	python3 influence_function_test.py --sen_attr race --dataset compas --seed $seed --constraint eopp --r 5 --t 1000 --gpu 2 --calc_option influence --target None
