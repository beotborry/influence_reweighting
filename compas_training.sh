...
do
	python3 main_final.py --dataset compas --method naive --seed $seed --constraint eopp --epoch 50 --iteration 1 --gpu 2
	...
	do
		python3 main_final.py --dataset compas --method naive_leave_k_out --seed $seed --constraint eopp --epoch 50 --iteration 1 --gpu 2 --k $k
		python3 main_final.py --dataset compas --method naive_leave_bottom_k_out --seed $seed --constraint eopp --epoch 50 --iteration 1 --gpu 2 --k $k
	done
done
