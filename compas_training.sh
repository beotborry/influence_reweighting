...
do
	...
	do
		python3 main_final.py --dataset compas --method naive_leave_k_out --seed $seed --constraint eo --epoch 50 --iteration 1 --gpu 1 --k $k --sen_attr sex --fine_tuning 0 --main_option fair_only --log_option last
		python3 main_final.py --dataset compas --method naive_leave_bottom_k_out --seed $seed --constraint eo --epoch 50 --iteration 1 --gpu 1 --k $k --sen_attr sex --fine_tuning 0 --main_option fair_only --log_option last
	done
done
