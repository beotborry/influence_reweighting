...
if args.calc_option == "grad_V":
    get_grad_V(args.constraint, train_loader, model, dataset, seed, save=True)
elif args.calc_option == "s_test":
    get_avg_s_test(model, train_loader, train_sampler, args.constraint, weights, r, dataset, seed, t, save=True)
elif args.calc_option == "influence":
    get_influence_score(model, train_loader, train_sampler, args.constraint, weights, dataset, seed, t, r, load_s_test=True)
