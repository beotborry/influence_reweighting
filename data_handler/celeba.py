...
class CelebA(data_handler.GenericDataset):
    ...
    def __init__(self, target_attr='Attractive', download=False, **kwargs):

        mean, std = get_mean_std('celeba', group=kwargs['group_mode'])
        ...
        self.features = [[s, l, filename] for s, l, filename in \
