...
do 
	python3 main_final.py --dataset retiring_adult --method naive --seed $seed --constraint eo --epoch 50 --iteration 1 --gpu 2 --sen_attr race --fine_tuning 0 --main_option fair_only --log_option all
	...
	python3 calc_influence.py --option fair --dataset retiring_adult --seed $seed --constraint eo --r 93 --t 10000 --gpu 2 --calc_option s_test --target None --sen_attr race --main_option fair_only
	python3 calc_influence.py --option fair --dataset retiring_adult --seed $seed --constraint eo --r 93 --t 10000 --gpu 2 --calc_option influence --target None --sen_attr race --main_option fair_only
	...
	do
		python3 main_final.py --dataset retiring_adult --method naive_leave_k_out --seed $seed --constraint eo --epoch 50 --iteration 1 --gpu 2 --k $k --sen_attr race --fine_tuning 0 --main_option fair_only --log_option last
		python3 main_final.py --dataset retiring_adult --method naive_leave_bottom_k_out --seed $seed --constraint eo --epoch 50 --iteration 1 --gpu 2 --k $k --sen_attr race --fine_tuning 0 --main_option fair_only --log_option last
	done
done
